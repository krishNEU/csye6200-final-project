...
public class PatientListJPanel extends javax.swing.JPanel {
    ...
    public PatientListJPanel(UserAccount userAccount, EcoSystem system, Network network,
            LogisticsOrganization systorganization) {
        initComponents();
        ...
        jPanel3Layout.setHorizontalGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(59, 59, 59)
                                .addComponent(jLabel25, javax.swing.GroupLayout.PREFERRED_SIZE, 910,
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAssignActionPerformed
        ...
        if (row < 0) {
            // JOptionPane.showMessageDialog(null, "Please select a row from the Request
            // table", "Warning", JOptionPane.WARNING_MESSAGE);
            // return;
            JOptionPane.showMessageDialog(null,
                    new JLabel("<html><b>Please select a row from the Request Table</b></html>"), "Warning",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
        if (row1 < 0) {
            // JOptionPane.showMessageDialog(null, "Please select a row from the Hospital
            // table", "Warning", JOptionPane.WARNING_MESSAGE);
            // return;
            JOptionPane.showMessageDialog(null,
                    new JLabel("<html><b>Please select a row from the Hospital Table</b></html>"), "Warning",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
            ...
            if (request.getStatus().equals("BoneMarrowBank Approved. Passing to System Coordinator")) {
                ...
                JOptionPane.showMessageDialog(null,
                        new JLabel("<html><b>Work Request is already in progress!</b></html>"), "Warning",
                        JOptionPane.WARNING_MESSAGE);
            }
