...
public class ManageNetworkJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblNetwork
                .setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 255, 204)));
        ...
        jPanel3Layout.setHorizontalGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 948,
        ...
        jPanel3Layout.setVerticalGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 58,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap()));
        ...
        if (txtNetWorkName.getText().isEmpty() || txtState.getText().isEmpty() || txtCountry.getText().isEmpty()) {
            ...
            for (Network network : system.getNetworkList()) {
                if (network.getName().equals(txtNetWorkName.getText())) {
                    JOptionPane.showMessageDialog(null, new JLabel("<html><b>Network Name can not be same!</b></html>"),
                            "Error", JOptionPane.ERROR_MESSAGE);

                    // JOptionPane.showMessageDialog(null, "Network name cannot be same!" , "Error",
                    // JOptionPane.ERROR_MESSAGE);
                    check1 = "no";
                    return;
                }
            ...
            if (!isAlpha(txtState.getText())) {
                // JOptionPane.showMessageDialog(null, "State name must be all alphabets." ,
                // "Error", JOptionPane.ERROR_MESSAGE);
                check1 = "no";
                txtState.setBorder(BorderFactory.createLineBorder(Color.RED));
                txtState.setForeground(Color.red);
                ...
                JOptionPane.showMessageDialog(null,
                        new JLabel("<html><b>Name of the State must contain only alphabets!</b></html>"), "Error",
                        JOptionPane.ERROR_MESSAGE);

            }
            if (!isAlpha(txtCountry.getText())) {
                // JOptionPane.showMessageDialog(null, "Country name must be all alphabets." ,
                // "Error", JOptionPane.ERROR_MESSAGE);
                check1 = "no";
                txtCountry.setBorder(BorderFactory.createLineBorder(Color.RED));
                txtCountry.setForeground(Color.red);
                JOptionPane.showMessageDialog(null,
                        new JLabel("<html><b>Name of the Country must contain only alphabets!</b></html>"), "Error",
                        JOptionPane.ERROR_MESSAGE);
    ...
    private void btnDeleteNetworkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteNetworkActionPerformed
        ...
        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(null, new JLabel("Select a network, to delete"), "Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (input == 0) {
            for (Network network : system.getNetworkList()) {
                if (network.getName().equals(tblNetwork.getValueAt(selectedRow, 0))) {
                    ...
                    JOptionPane.showMessageDialog(null, new JLabel(nName + " network deleted Succesfully!!"), "Error",
                            JOptionPane.ERROR_MESSAGE);
                    populateNetworkTable();
                    return;
                }
